...
class BasePanel(ScreenPanel):
    def __init__(self, screen, title, back=True, action_bar=True, printer_name=True):
        ...
        self.title_spacing = self._gtk.font_size * 3
    ...
    def show_heaters(self, show=True):
        ...
        if self._printer.has_heat_up():
            ...
            heater_bed_box.pack_start(heater_bed, True, 7, 7)
            heater_bed_box.pack_start(self.labels['heat-up'], True, 5, 5)
            self.control['temp_box'].pack_end(heater_bed_box, True, 7, 7)
